    ...
    <Modal
      ...
      footer={
        <div className="flex justify-end gap-3">
          ...
          <Button disabled={!rationale} onClick={handleSubmit} className="px-6">
            Confirm Override
          </Button>
        </div>
      }
    >
      <div className="flex flex-col gap-6">
        <div className="p-4 rounded-interactive bg-critical/10 border border-critical/20 text-critical-dark text-sm leading-relaxed">
          ...
          <p>
            You are assigning a task to a specialist who is already at or over
            100% capacity. This bypasses sustainable floors and increases the
