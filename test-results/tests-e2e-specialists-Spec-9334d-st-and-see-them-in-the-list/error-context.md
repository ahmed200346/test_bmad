...
- Name: tests\e2e\specialists.spec.ts >> Specialist Management >> should create a new specialist and see them in the list
- Location: tests\e2e\specialists.spec.ts:4:7
